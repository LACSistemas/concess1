"""
People Counter Router
Handles endpoints for counting people in videos
"""
...
async def process_video(
    ...
    """Start processing a video to count people"""
    ...
    # In a real implementation, you would run the people_counter.py script here
...
async def simulate_processing(job_id: str, request: ProcessRequest):
    ...
    for frame in range(0, total_frames + 1, 30):
        ...
        jobs[job_id]["detected_count"] = random.randint(5, 20)
...
async def download_video(job_id: str):
    ...
    return FileResponse(video_path, media_type="video/mp4", filename=f"people_counted_{job_id}.mp4")
